...
<main>
    <section class="aboutSection">
            <img class="portrait" src="images/headshot_square.jpg" alt="Portrait">
        <div class="about">
            <h1 class="heading">Nick Shahfazlollahi</h1>
            <h3 class="subheading">About me</h3>
            <p class="aboutParagraph">I'm a 22 year old designer, media enthusiast and aspiring content creator from London, Ontario. Aside from design, I am a huge automotive enthusiast, animal lover and basketball fanatic. My favouite past time is beer or wine tasting, a night out with freinds, and the odd sleep when I can get some!</p>
        </div>       
    </section>
    ...
    <section class="educationSection">
        ...
        <div class="school">
            <div class="western">
                <h3 class="subheading">Western University</h3>
                <p class="aboutParagraph">Two years of finance, marketing and business administration.</p>
            </div>
            <div class="fanshawe">
                <h3 class="subheading">Fanshawe College</h3>
                <p class="aboutParagraph">Completed the Pre-media program with a 3.9GPA as well as honour roll and deans list.</p>
                <p class="grad">Graduate Certificate</p>
            </div>
            <div class="fanshawe">
                <h3 class="subheading">Fanshawe College</h3>
                <p class="aboutParagraph">Completed the Interactive Media and Design program.</p>
                <p class="grad">Graduate Diploma</p>
            </div>
