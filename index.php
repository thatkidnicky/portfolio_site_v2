...
<body>
    ...
    <nav class="navContainer hide">
        ...
        <main class="home">
                <div class="promoVid">
                    <iframe width='100%' height='100%' src="https://www.youtube.com/embed/rviR-th37TU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                
                    <section class="welcomeSection">
                            <h1 class="welcome">Welcome to Nick Shahfazlollahi's portfolio site.</h1>
                        <div class="headshot" alt="Headshot"></div>
                    </section>
                
                    <p class="enter">Enter the mind of a creative designer, aspiring content creator and a media enthusiast.</p>
