...
<header class="header">
    ...
    <section>
        ...
        <div>
            <p class="thxP">Your form has been sent! Sit back and relax while I take some time to thoughtfully read and respond to you. The waiting process can be sped up by kicking back and cracking a cold one.</p>
        </div>
    
        <div>
           <a href="index">Return to Site</a>
        </div>
    </section>
